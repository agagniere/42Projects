...
#    Updated: 2015/07/17 10:04:23 by angagnie         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#    By: $USER <$USER@student.42.fr>          +#+  +:+       +#+         #
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2015/07/16 21:49:46 by $USER          #+#    #+#              #
#    Updated: 2015/07/16 21:49:54 by $USER         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
fi" > ex02/find_nicolas_bomber.sh
...
#    By: $USER <$USER@student.42.fr>          +#+  +:+       +#+         #
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2015/07/16 21:50:25 by $USER          #+#    #+#              #
#    Updated: 2015/07/16 21:50:29 by $USER         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

stat -t %s bomb.txt | cut -d ' ' -f 9 | tr -d '\\\"' > tmp
echo ' - 1' >> tmp
cat tmp | tr '\n' ' ' | sed \"s/ //\" | bc" > ex02/defuse.sh
